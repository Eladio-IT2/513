            ...
            <div class="admin-card">
                ...
                <form method="post" class="admin-form">
                    ...
                    <div>
                        ...
                        <input type="text" id="image" name="image" placeholder="/assets/images/products/product-name.jpg" value="<?php echo htmlspecialchars($product['image_path'] ?? $product['image_url'] ?? ''); ?>" required>
                        <small>Enter the image path starting with / (e.g., /assets/images/products/product-name.jpg)</small>
                    </div>
                    <div>
